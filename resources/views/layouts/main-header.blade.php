								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{Route('MarkAsRead_All')}}">تعيين قراءة الكل </a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notification_count">
											عدد الاشعارات غير المقروءة {{ auth()->user()->unreadNotifications->count() }}
											</p>
									</div>
