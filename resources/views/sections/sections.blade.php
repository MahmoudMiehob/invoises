						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									@can('اضافة قسم')
									<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">{{__('messages.section_add')}}</a>
									@endcan
								</div>
							</div>
											...
											<tr>
                                                ...
                                                @can('تعديل قسم')
													<a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
														...
														href="#exampleModal2" title="{{__('messages.edit')}}"><i class="las la-pen"></i></a>
												@endcan
		
												@can('حذف قسم')
													<a class="btn btn-sm btn-danger" 
														data-section_id="{{ $section->id }}" data-section_name="{{ $section->section_name }}"
														data-toggle="modal" href="#modaldemo9" title="{{__('messages.delete')}}"><i
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content modal-content-demo">
								<div class="modal-header">
									<h6 class="modal-title">{{__('messages.section_add')}}</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
								</div>
								<div class="modal-body">
									<form action="{{ route('sections.store') }}" method="post">
										...
										<div class="form-group">
											<label for="exampleInputEmail1">{{__('messages.section_name')}}</label>
