            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoces.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">{{__('messages.invoices_num')}}</label>
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="يرجي ادخال رقم الفاتورة" required>
                            </div>

                            <div class="col">
                                <label>{{__('messages.invoices_date')}}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">{{__('messages.Amount_collection')}}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">{{__('messages.Amount_Commission')}}</label>
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="" selected disabled>{{__('messages.Rate_VAT_select')}}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">{{__('messages.Total_val')}}</label>
                        ...
                        <p class="text-danger">* {{__('messages.Attachment_Formula')}} pdf, jpeg ,.jpg , png </p>
