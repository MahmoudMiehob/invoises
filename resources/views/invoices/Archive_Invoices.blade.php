...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('messages.invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{__('messages.invoices_Archives')}}</span>
            </div>
        </div>
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                        data-toggle="modal" data-target="#Transfer_invoice"><i
                                                            class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;{{__('messages.invoice_transfer')}}</a>
                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
