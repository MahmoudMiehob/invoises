...
use App\User;use Spatie\Permission\Models\Role;
use DB;
use Hash;
...
class UserController extends Controller{
    ...
    public function create(){
        ...
        public function store(Request $request){
            $this->validate($request, ['name' => 'required','email' => 'required|email|unique:users,email','password' => 'required|same:confirm-password','roles_name' => 'required']);
            $input = $request->all();
